...
public interface SearchService<T> {
	 ...
	 * 
	 * Example below will search <code>AppUser</code> class for occurences of "obreza" in listed fields. Returns matches from 0 to 50.
	 * 
	 * <pre>
	 * service.search("obreza", com.vasworks.security.model.AppUser.clazz, new String[] { "displayName", "username" }, 0, 50);</pre>
	 * 
	 * 
	 * @see PagedResult
	 * 
