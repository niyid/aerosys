...
public class NotificationSubscriptionServiceImpl implements NotificationSubscriptionService {
	...
	/**
	 * @see com.devworks.projecttask.service.NotificationSubscriptionService#listAvailableNotifications(com.vasworks.security.model.AppUser)
	 */
	@Override
	public List<Method> listAvailableNotifications(AppUser user) {
	...
	/**
	 * @see com.devworks.projecttask.service.NotificationSubscriptionService#getSubscriptions(com.vasworks.security.model.AppUser)
	 */
	@SuppressWarnings("unchecked")
	@Override
	@Transactional
	public Hashtable<String, UserNotification> getSubscriptions(AppUser user) {
	...
	@Override
	@Transactional
	public void updateSubscriptions(AppUser user, Dictionary<String, UserNotification> subscriptions) {
	...
	@Transactional
	@SuppressWarnings("unchecked")
	public List<UserNotification> getUserNotifications(String eventName, EventNotificationType eventNotificationType, List<AppUser> allowedSubscribers) {
