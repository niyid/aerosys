...
<div class="panel-group">
	<div class="panel panel-primary">
		<div class="panel-heading"><s:if test="personnelId != null">Edit </s:if><s:else>Add </s:else> Agency Employee</div>
		<div class="panel-body">
			<s:form id="agencyEmployeeForm" action="agencyEmployeeRecord!save" validate="true" method="post" namespace="/setup/ajax" theme="xhtml">
				...
				<sj:submit button="true" value="Save" buttonIcon="ui-icon-gear" targets="agencyEmployeeFormDiv" onCompleteTopics="refreshAgencyEmployeeListDiv" effect="highlight" effectDuration="500" />
			</s:form>		
		</div>
	</div>
</div>	
