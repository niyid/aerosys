...
%>	
	...
	$(document).ready(function(){
		if(!location.href.endsWith("index.jspx")) {
			location.href = "${pageContext.request.contextPath}/index.jspx";
		}
	});
	</script>
