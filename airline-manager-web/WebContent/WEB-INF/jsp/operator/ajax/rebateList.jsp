...
<div class="panel-group">
	<div class="panel panel-primary">
		...
		<div class="panel-body" id="rebateListInnerDiv">
			<table class="table table-hover table-striped">
				<thead>
					<tr>
						<td width="30%">Description</td>
						<td width="15%">Code</td>
						<td width="30%" style="text-align:right">Rate Amount/Percentage</td>
				...
				<s:iterator value="rebates">
					<tr>
						...
						<td style="text-align:right">
							...
							<sj:a cssClass="btn btn-primary btn-lg" href="%{selUrl}" onClickTopics="blockUIOn" onCompleteTopics="blockUIOff" targets="rebateFormDiv"><span class="glyphicon glyphicon-edit"></span>Edit</sj:a>
						</td>
					</tr>
				</s:iterator>
			</table>		
