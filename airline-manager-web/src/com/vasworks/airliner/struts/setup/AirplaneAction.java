...
import com.vasworks.airliner.model.Airplane.OperationType;
...
public class AirplaneAction extends OperatorAction {
	...
	@Validations(
			requiredStrings = {
				...
				@RequiredStringValidator(fieldName = "entity.serialNumber", message = "'Serial Number' is required."),
				@RequiredStringValidator(fieldName = "entity.ownerName", message = "'Owner' is required.")
			},
			requiredFields = {
				@RequiredFieldValidator(fieldName = "entity.manufactureDate", message = "'Manufacture Date' is required."),
				@RequiredFieldValidator(fieldName = "entity.arrivalDate", message = "'Arrived in Country' is required."),
				@RequiredFieldValidator(fieldName = "entity.operationType", message = "'Operation Type' is required.")
			}
		)
	public String save() {
		operatorService.saveAirplane(entity, regNumber, getAirlineId(), modelName, getUserId());
	...
	public String list() {
		airplanes = operatorService.listAirplanes(getAirlineId());
	...
	public OperationType[] getOperationTypeLov() {
