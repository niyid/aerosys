...
@StrutsTag(name = "filedropzone", tldTagClass = "com.vasworks.tags.views.jsp.ui.FileDropZoneTag", description = "Renders file drag-and-drop zone")
public class FileDropZone extends ClosingUIBean {
	public static final String OPEN_TEMPLATE = "filedropzone";
	public static final String TEMPLATE = "filedropzone-close";
	final protected static Log LOG = LogFactory.getLog(FileDropZone.class);
	...
	public FileDropZone(ValueStack stack, HttpServletRequest request, HttpServletResponse response) {
