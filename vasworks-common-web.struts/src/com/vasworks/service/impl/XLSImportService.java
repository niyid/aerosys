...
import com.vasworks.service.DataImportService;
import com.vasworks.service.XLSDataImportService;
...
public class XLSImportService implements DataImportService, XLSDataImportService {
	...
	private Hashtable<String, Query> queryCache;
	...
	/**
	 * @see com.vasworks.service.DataImportService#importFromStream(java.io.InputStream, java.lang.Class, java.lang.String[])
	 */
	@Transactional()
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.devworks.projecttask.service.impl.DataImportService#importFromStream(java.io.InputStream, java.lang.Class, java.lang.String[])
	 */
	/**
	 * From stream.
	 * 
	...
	public List<?> persistObjectsFromXLS(Class<?> targetEntity, Hashtable<String, String> mappings, HSSFSheet xlsSheet) throws XLSImportException {
		...
		this.queryCache = new Hashtable<String, Query>();
		...
		for (int rowIndex = 1; rowIndex <= lastRowNum; rowIndex++) {
			...
			try {
				for (String prefix : topObjects) {
					doMagic4(prefix, targetEntity, existingObject, sortedExpressions, existingValues, newValues, dataTypes, ognlContext);
				}
	...
	private void doMagic4(String prefix, Class<?> objectType, Object existingObject, List<String> sortedExpressions, Hashtable<String, Object> existingValues,
			Hashtable<String, Object> newValues, Hashtable<String, Class<?>> dataTypes, OgnlContext ognlContext) throws OgnlException {
		...
		if (prefix == null) {
			...
			if (existingValue == null) {
				...
				existingValue = findOrCreate(prefix, objectType, sortedExpressions, existingValues, newValues, ognlContext);
			} else {
	...
	private Object findOrCreate(String prefix, Class<?> objectType, List<String> sortedExpressions, Hashtable<String, Object> existingValues,
			Hashtable<String, Object> newValues, Map ognlContext) {
		...
		Query query = this.queryCache.get(queryKey);
		if (query == null) {
			...
			this.queryCache.put(queryKey, query);
		}
	...
	@SuppressWarnings("unchecked")
	private void fillObject(String prefix, List<String> sortedExpressions, Hashtable<String, Object> newValues, Map ognlContext, Object object) {
	...
	/**
	 * @see com.vasworks.service.XLSDataImportService#getObjectsFromXLS(java.util.Hashtable, org.apache.poi.hssf.usermodel.HSSFSheet)
	 */
	@Override
	public List<Object[]> getObjectsFromXLS(HSSFSheet xlsSheet) {
		// find column indexes
		HSSFRow topRow = xlsSheet.getRow(0);
		int columns = topRow.getLastCellNum() - topRow.getFirstCellNum();
		LOG.debug("Sheet has " + columns + " columns");
