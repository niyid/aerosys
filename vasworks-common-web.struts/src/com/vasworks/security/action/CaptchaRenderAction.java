...
import com.vasworks.struts.DownloadableStream;
...
public class CaptchaRenderAction extends BaseAction implements DownloadableStream, CaptchaValidator {
	...
	/**
	 * @see com.vasworks.security.action.CaptchaValidator#setCaptchaService(com.octo.captcha.service.image.ImageCaptchaService)
	 */
	...
	/**
	 * @see com.vasworks.struts.DownloadableStream#getDownloadFileName()
	 */
	@Override
	...
	/**
	 * @see com.vasworks.struts.DownloadableStream#getDownloadStream()
	 */
	@Override
	...
	/**
	 * @see com.vasworks.security.action.CaptchaValidator#isCaptchaValid(java.lang.String)
	 */
