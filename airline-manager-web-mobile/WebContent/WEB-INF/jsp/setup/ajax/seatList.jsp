...
<html>
	...
	<body>
			<s:form id="seatListForm" action="seatList" namespace="/setup/ajax" theme="xhtml">
				...
				/>
				<sj:submit button="true" cssStyle="display: none;" value="Submit" targets="seatListDiv" listenTopics="airplaneSelectedTopic" effect="highlight" effectDuration="500" indicator="indicator" />			
			</s:form>
			<table>
				<tr>
					<td width="30%">
