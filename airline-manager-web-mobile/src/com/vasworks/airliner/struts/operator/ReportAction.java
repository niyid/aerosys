...
public class ReportAction extends OperatorAction {
	...
	public String execute() {
		if(flightNumber != null && flightDate != null) {
			tickets = operatorService.listTicketSales(new FlightId(flightNumber, ((Airline) ((Personnel) getUser()).getOrganization()).getAirlineCode(), flightDate));
			unsoldSeats = operatorService.listUnsoldSeats(new FlightId(flightNumber, ((Airline) ((Personnel) getUser()).getOrganization()).getAirlineCode(), flightDate));
		} else {
